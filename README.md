# 🎓 Yapay Zeka Hocam - Dijital Çalışma Arkadaşım

Merhaba, ben Rabiya. Bu projeyi, elimde var olan ve nereden başlayacağımı bilemediğim ders notlarımla karşı karşıya kaldığımda, "Keşke biri şu notları özetlese de anlatsa" dediğim yoğun sınav dönemlerim için geliştirdim.

Bu uygulama, yüklediğim PDF notlarını alıyor ve seçtiğim moda göre benimle sohbet edebilen, beni sınava hazırlayan dijital bir hocaya dönüşüyor.

## 💡 Neden Yaptım? & Ne İşe Yarıyor?
...
* **📝 Sınav Oluşturuyorum (Öğrenci & Öğretmen Dostu):**
    ...
    * **Öğretmenler de bu özelliği kullanarak öğrencileri için saniyeler içinde, cevap anahtarı hazır sınav kağıtları oluşturabilir.**
    * Hazırlanan sınavı çıktı almak için **PDF** olarak indiriyorum.

## 🛠️ Kullandığım Teknolojiler

Projeyi Python kullanarak geliştirdim.
